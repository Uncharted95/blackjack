...
**Description**
The code has several functions which primarily contain for loops, conditionals (if, else-if) and Booleans. Both the user and the dealer has near identical lines of code as they're both programmed to draw cards and will win or lose depending on whether or not they get blackjack or exceed 21. 


**Installing**
This runs on a local browser via an extension through VSCode 

**Executing program**
Running the program requires interacting with the user interface.
